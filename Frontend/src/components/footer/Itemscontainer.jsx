    ...
    <div className="max-w-screen-xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 px-6 py-16">
        ...
        <div className="space-y-4">
          <div className="text-cyan-300 text-4xl font-bold tracking-tighter 
                        border-l-4 border-cyan-300/30 pl-3">CY.</div>
        ...
        <div className="backdrop-blur-sm"><Item Links={Explore} title="Explore" /></div>
        <div className="backdrop-blur-sm"><Item Links={Visit} title="Visit" /></div>
        <div className="backdrop-blur-sm"><Item Links={Socials} title="Follow Us" /></div>
      </div>
    </div>
  );
};
