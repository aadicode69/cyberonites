        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-12">
          ...
          <section className="space-y-4">
            <div className="flex items-center space-x-3">
              <h1 className="text-2xl sm:text-3xl font-bold exv2-font-cyberjunkies">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-orange-400 font-semibold text-sm">November 8-9, 2025</span>
            </div>
          </section>

          {/* Event Info */}
          <section className="space-y-4">
            <h2 className="text-white font-bold text-lg mb-4 exv2-font-clouds">
              Event <span className="text-orange-500">Information</span>
            </h2>
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                <span className="text-gray-300 text-sm">GLA University, Mathura</span>
              </li>
              <li className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <address className="flex items-center space-x-3 text-gray-300 not-italic">
                <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                </div>
                <span className="text-sm">GLA University, Mathura, UP</span>
              </address>
            </div>
            ...
            <nav className="flex space-x-3 mt-6">
              ...
              <a
                href="https://www.cyberonites.com"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-orange-500/20 hover:border-orange-500/30 transition-all duration-300 group"
                aria-label="Website"
