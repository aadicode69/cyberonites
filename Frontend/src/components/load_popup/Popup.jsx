...
import intrusionPoster from "../../img/events/IntrusionX_ban_mob.png";
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-md bg-black font-clash bg-opacity-60 flex justify-center items-center z-[9999] p-4">
      ...
      >
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 text-center">
          IntrusionX
        </h2>
        ...
        <p className="mt-2 text-xs md:text-sm text-gray-400 text-center px-2">
          Stay tuned. Clues are hidden. The game begins soon 
