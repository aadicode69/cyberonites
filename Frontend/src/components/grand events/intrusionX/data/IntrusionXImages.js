...
// Main event overview images - used for hero sections and section headers
export const eventBannerImg = eventBannerImgFile;
export const judgesImg = judgesImgFile;
export const teamsImg = teamsImgFile;
export const winnersImg = winnersImgFile;

// Featured speakers and highlights - used for spotlight sections
export const judgesPanelImg = judgesPanelImgFile;
export const cyberYaanCEOImg = cyberYaanCEOImgFile;
export const additionalEvalImg = additionalEvalImgFile;

// Team with alumni gallery - shows collaboration between current and former members
export const teamWithAlumniImages = [
  teamWithAlumniImage1,
  teamWithAlumniImage2,
  teamWithAlumniImage3
];

// Individual winner images - for specific highlight sections
export const winnerImg1 = winnerImg1File;
export const winnerImg2 = winnerImg2File;
export const winnerImg3 = winnerImg3File;
export const winnerImg4 = winnerImg4File;
export const runnerUpImg1 = runnerUpImg1File;
export const runnerUpImg2 = runnerUpImg2File;
export const secondRunnerUpImg1 = secondRunnerUpImg1File;
export const secondRunnerUpImg2 = secondRunnerUpImg2File;
...
export const secondPlaceWinnerImages = [
  runnerUpImg1File,
  runnerUpImg2File
];

export const thirdPlaceWinnerImages = [
  secondRunnerUpImg1File,
  secondRunnerUpImg2File
];

// All team participant images - for team gallery section
...
// Images documenting the evaluation process - for methodology section
export const evaluationImages = [
  evaluationImage1,
  evaluationImage2,
  evaluationImage3,
  evaluationImage4,
...
// Detailed images of judges - for judge profiles section
export const judgeDetailImages = [
  judgeDetailImage1,
  judgeDetailImage2,
  judgeDetailImage3,
  judgeDetailImage5,
...
// Images of guest speakers - for guest highlight section
export const guestDetailImages = [
  guestDetailImage1,
  guestDetailImage2,
  guestDetailImage3,
  guestDetailImage4
...
// Sponsor logos - for sponsor acknowledgment section
...
// Faculty coordinator image
export const facultyCoordinatorImg = coordinatorImg;

// Add mentor images export
export const mentorImages = {
  mentor1: mentorImage1, // Dr. Sandeep Rathod
  mentor2: mentorImage2  // Dr. Arvind Prasad
};
