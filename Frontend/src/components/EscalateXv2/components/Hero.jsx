...
const Hero = () => {
  useEffect(() => {
    ...
    const updateCountdown = () => {
      ...
      if (distance > 0) {
        ...
        document.getElementById("escalateX-days").textContent = days
          .toString()
          .padStart(2, "0");
        document.getElementById("escalateX-hours").textContent = hours
          .toString()
          .padStart(2, "0");
        document.getElementById("escalateX-minutes").textContent = minutes
          .toString()
          .padStart(2, "0");
        document.getElementById("escalateX-seconds").textContent = seconds
          .toString()
          .padStart(2, "0");
      } else {
  ...
  return (
    <section
      id="section1"
      className="carousel-section escalateX-hero-section main-section escalateX-hero-with-blur"
    >
        ...
        <div className="flex flex-col h-full justify-center space-y-6">
          ...
          <div className="escalateX-hero-title-section flex-shrink-0">
            <aside className="inline-flex items-center space-x-2 px-3 py-1.5 escalateX-glass-card border border-orange-500/50 escalateX-holographic mb-4">
              ...
              <span className="text-orange-300 font-semibold text-xs font-orbitron tracking-wider">
            ...
            <div className="escalateX-hero-container">
              <h1
                className="escalateX-sci-fi-title escalateX-hero escalateX-glitch escalateX-layers flex flex-row items-center justify-start gap-4 flex-nowrap"
                style={{
                  fontFamily:
                    '"Audiowide", "Orbitron", "Share Tech Mono", monospace',
                }}
              ...
              >
                ...
                <img
                  src={logo}
                  alt="ESCALATE v2 Logo"
                  className="escalateX-hero-logo-image object-contain flex-shrink-0"
                />
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              ...
              <div className="escalateX-hero-description space-y-6 flex flex-col justify-start">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 pt-6">
                  <button
                    id="escalateX-registerBtn"
                    className="w-full sm:w-auto escalateX-cyber-button escalateX-cyber-button-primary escalateX-cyber-button-extra-large flex items-center justify-start gap-6 px-12 py-6 text-xl font-bold"
                  >
              ...
              <div className="escalateX-hero-cards space-y-6 flex flex-col justify-start">
                <div className="escalateX-glass-card escalateX-cyber-terminal escalateX-data-stream escalateX-enhanced-card escalateX-countdown-card">
                  <h3 className="text-lg lg:text-xl font-bold mb-4 escalateX-cyber-header-text font-orbitron flex items-center gap-2">
                    <FaHourglassHalf className="text-orange-400" /> COUNTDOWN TO
                    LAUNCH
                  </h3>
                  <div className="escalateX-countdown-grid">
                    <div className="escalateX-countdown-item">
                      <span
                        id="escalateX-days"
                        className="escalateX-countdown-number"
                      >
                        00
                      </span>
