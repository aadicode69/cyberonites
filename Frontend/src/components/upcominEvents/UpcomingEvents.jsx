    ...
    >
      ...
      <div className="relative w-[90vw] max-w-[1400px] p-4 rounded-xl border-[0.5px] border-gray-700 shadow-xl backdrop-blur-lg bg-transparent overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 font-clash mt-6 mb-6">
          <button
            className="relative overflow-hidden bg-gradient-to-r from-cyan-500 to-indigo-600 text-white py-2 sm:py-3 px-6 sm:px-10 text-base sm:text-lg rounded-md border-none shadow-lg transition-all duration-300 transform hover:scale-110 hover:rotate-2 hover:shadow-[0_0_20px_#3F51B5] group"
          ...
          <button
            className="relative overflow-hidden bg-gradient-to-r from-gray-900 to-black text-white py-2 sm:py-3 px-6 sm:px-10 text-base sm:text-lg rounded-lg border-none shadow-lg transition-all duration-500 transform hover:scale-105 hover:-rotate-2 hover:shadow-[0_0_15px_#9CA3AF] group"
