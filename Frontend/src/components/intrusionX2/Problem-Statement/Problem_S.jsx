...
import problemsData from './Problems2.json';
    ...
    <div className="min-h-screen relative bg-[#050505] text-slate-300 pt-[60px] md:pt-[80px] pb-0 px-4 sm:px-8 lg:px-12 font-sans selection:bg-cyan-500/30 overflow-hidden">
      ...
      <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50">
        <Link
          ...
          title="Back to IntrusionX2 Home"
        >
        ...
        <div className="text-center mb-8 relative flex flex-col items-center">
          ...
          <div className="text-center mb-10 md:mb-12 relative group cursor-default flex flex-col items-center">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl lg:text-[5rem] font-black italic -skew-x-[10deg] tracking-tighter drop-shadow-[0_0_15px_rgba(34,211,238,0.2)] transition-all duration-500 uppercase flex items-center justify-center leading-none text-slate-100"
            >
              <span className="inline-block transition-transform duration-500 group-hover:-translate-x-2 group-hover:-translate-y-1">Intrusion</span>
              <span className="inline-block transition-transform duration-500 text-transparent bg-clip-text bg-gradient-to-br from-cyan-300 to-blue-600 drop-shadow-[0_0_15px_rgba(34,211,238,0.8)] ml-1 group-hover:translate-x-2 group-hover:-translate-y-1">X2</span>
            </motion.h1>
        ...
        <div className="bg-gradient-to-b from-slate-900/80 to-[#050505] backdrop-blur-2xl border-t border-slate-800/40 px-6 md:px-12 py-8">
          ...
          <div className="max-w-[1440px] mx-auto mt-6 pt-4 border-t border-slate-800/40 flex justify-center">
            <p className="text-slate-700 font-mono text-[9px] tracking-[0.3em] uppercase">
              © 2026 Cyberonites &nbsp;·&nbsp; All Rights Reserved &nbsp;·&nbsp; IntrusionX2
            </p>
          </div>
        </div>
      </footer>
