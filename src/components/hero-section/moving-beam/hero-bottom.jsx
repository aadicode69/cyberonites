...
export default function HeroBottom() {
  return (
    <div className="relative flex flex-col-reverse justify-center items-center">
      ...
      <DescriptionArea className="absolute right-36 top-5 w-[36vw] max-lg:hidden p-5 xl:text-lg" />

      <TagLine classNameBox="absolute left-44 top-5 w-[36vw] max-lg:hidden p-5" />
    </div>
  );
}
